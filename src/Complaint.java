...
public class Complaint {
	...
	public Complaint(LocalDate dateReceived, String product, String subProduct, String issue, String subIssue,
			...
			String timelyResponse, String conDisputed, int complaintID) {
		super();
	...
	public String getConDisputed() {
		return conDisputed;
	}

	public void setConDisputed(String conDisputed) {
		this.conDisputed = conDisputed;
	}
